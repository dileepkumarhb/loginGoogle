...
const OrderDetailsPage = () => {
  ...
  const orderDetails = useSelector((state) => state.userAddress.orderDetails);
console.log('orderDetailsssssssssssssssssssssss',orderDetails)

  console.log('iddddddddddddd',id.orderId)

  useEffect(() => {
    console.log('idddddddddddddd',id.orderId);
    const payload = {
      orderId: id.orderId,
    };
          ...
          >
            <div className="flexRow">
              <div className="delItemImgContainer">
                <img src={generatePublicUrl(item.productId.images[0].img)} alt="" />
              </div>
